...
export class FormComponent implements OnInit {
  ...
  createForm() {
    this.form = this.fb.group({
      userName: [
        { value: 'defaultname', disabled: false },
        [
          Validators.required,
      ...
      password: [
        { value: 'R@ils', disabled: false },
        [Validators.required, passwordValidator()],
      ],
      email: [
        { value: 'default@gmail.com', disabled: true },
        [Validators.required, Validators.email],
      ],
      mobileNumber: [
        { countrycode: '+91', mobile: '9952029596' },
        [Validators.required],
      ],
      number: [
